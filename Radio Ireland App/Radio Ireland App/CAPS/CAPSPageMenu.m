...
{
    _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(0.0, 10.0, menuItemWidth, menuScrollViewHeight - indicatorHeight)];
...
- (void)initValues
{
    ...
    _menuItemFont = [UIFont systemFontOfSize:35.0];
...
- (void)setUpUserInterface
{
    ...
    //NSLog(@"Menu Height : %f", _menuHeight);
    ...
    if (_addBottomMenuHairline) {
       ...
       // //NSLog(@"**** Hairline : %f ****", menuBottomHairline.frame.size.height);
...
- (void)configureUserInterface
{
    ...
    //NSLog(@"_menuHeight* , %f",_menuHeight);
